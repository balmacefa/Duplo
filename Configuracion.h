...
#define FRECUENCIA_LECTURA_AJUSTE_PAPEL 64
...
#define TIM_ENTRADA_TOPE_ENGRAPAR 600//Tiempo donde se activa el tope para el engrape del papel, puede ser el mismo que TIM_ENTRADA_AJUSTE_HORI_VERT_PAPEL
#define TIM_SIG_TOPE_ENGRAPAR 1000//Tiempo que permanece la segnal del tope engrapado en el rele
