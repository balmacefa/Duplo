...
#define TIM_TEST_LIBERAR_AJUSTES -1 //Tiempo para liberar los ajustes para engrapar, el tope y los ajsute de papel
...
//Dobladora
#define TIM_ENTRADA_TOPE_DOBLADORA -1//Tiempo donde se activa el tope para DOBLAR el papel
#define TIM_SIG_TOPE_DOBLADORA -1//Tiempo que permanece la segnal del tope DOBLADORA en el rele
